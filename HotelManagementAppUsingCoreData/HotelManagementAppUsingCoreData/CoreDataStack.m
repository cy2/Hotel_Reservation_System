...
-(instancetype)initForTesting {
        NSLog(@" CoreDataStack > initForTesting fired");
    self = [super init];
    if (self) {
        self.isTesting = true;
    }
...
-(void)seedDataBaseIfNeeded {
        NSLog(@" CoreDataStack > seedDataBaseIfNeeded fired");
...
- (NSURL *)applicationDocumentsDirectory {
        NSLog(@" CoreDataStack > applicationDocumentsDirectory fired");
...
- (NSManagedObjectModel *)managedObjectModel {
        NSLog(@" CoreDataStack > managedObjectModel fired");
    // The managed object model for the application. It is a fatal error for the application not to be able to find and load its model.
    if (_managedObjectModel != nil) {
        return _managedObjectModel;
    }
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"HotelManagementAppUsingCoreData" withExtension:@"momd"];
    _managedObjectModel = [[NSManagedObjectModel alloc] initWithContentsOfURL:modelURL];
    return _managedObjectModel;
}

- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
        NSLog(@" CoreDataStack > persistentStoreCoordinator fired");
    ...
    if (self.isTesting) {
        ...
        NSLog(@" CoreDataStack > persistentStoreCoordinator IN TEST MODE");
        
    } else {
        storeType = NSSQLiteStoreType;
        NSLog(@" CoreDataStack > persistentStoreCoordinator IN APP MODE");
    }
...
- (NSManagedObjectContext *)managedObjectContext {
        NSLog(@" CoreDataStack > managedObjectContext fired");
...
- (void)saveContext {
        NSLog(@" CoreDataStack > saveContext fired");
